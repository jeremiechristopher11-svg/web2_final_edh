...
export function TechnicienDashboard() {
  ...
  return <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              backgroundColor: "#5B9BD520"
                ...
                <Wrench className="w-6 h-6" style={{
                color: "#5B9BD5"
              }} />
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {myInterventions.map(intervention => <div key={intervention.id} className="p-4 border border-gray-200 rounded-lg hover:border-[#F5A623] transition-colors">
      ...
      {/* Completed today */}
      {completedToday.length > 0 && <Card>
          <CardHeader>
            <CardTitle>Interventions terminées aujourd'hui</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {completedToday.map(intervention => <div key={intervention.id} className="p-4 bg-green-50 border border-green-200 rounded-lg">

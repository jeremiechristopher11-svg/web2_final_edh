      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent>
              <form onSubmit={handleSubmitProblem} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea id="problem" placeholder="Décrivez le problème que vous rencontrez (coupure de courant, tension faible, etc.)" rows={5} value={problemDescription} onChange={e => setProblemDescription(e.target.value)} />
                </div>
          ...
          <Card>
            ...
            <CardContent>
              {demandes.length === 0 ? <p className="text-center text-gray-400 py-8">Aucune demande pour le moment</p> : <div className="space-y-3">
                  {demandes.map(demande => <div key={demande.id} className="p-4 border border-gray-200 rounded-lg">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {mockFactures.map(facture => <div key={facture.id} className="p-4 border border-gray-200 rounded-lg hover:border-[#F5A623] transition-colors">

...
export function ChefTechnicienDashboard() {
  ...
  return <div className="space-y-6">
      ...
      <div>
        ...
        color: "#1A1A1A"
      }}>Tableau de bord - Chef des techniciens</h1>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {recentPannes.map(panne => <div key={panne.id} className="p-4 border border-gray-200 rounded-lg">
                  <div className="flex items-start justify-between">
                    ...
                    color: "#1A1A1A"
                      ...
                      <p className="text-xs text-gray-400 mt-2">
                        {panne.status !== "en-attente" ? `Assigné à: ${panne.technicien}` : "Non assigné"}
                      </p>
                    </div>
                  </div>
                </div>)}
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {teamPerformance.map(tech => <div key={tech.technicien} className="p-4 border border-gray-200 rounded-lg">
